...
namespace UFSFacilityManagement.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        public async Task<IActionResult> ProcessTransaction()
        {
            ...
            var transactions = await _context.Transactions.Include(t => t.Booking).ToListAsync();
        ...
        public void GeneratePdf(List<Transaction> transactions)
        {
            ...
            foreach (var transaction in transactions)
            {
                ...
                doc.Add(new Paragraph($"Amount: {transaction.Amount.ToString("C")}"));
